...
public class Detail_delight_lei extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_delight_lei);

        btnOrder = (Button) findViewById(R.id.btn_delight_lei);
        tableNumber = (EditText) findViewById(R.id.edt_delight_lei);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("LEI CHA", "129");
