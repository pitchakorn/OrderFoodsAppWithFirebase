...
public class Detail_eastern_abc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_eastern_abc);

        btnOrder = (Button) findViewById(R.id.btn_eastern_abc);
        tableNumber = (EditText) findViewById(R.id.edt_eastern_abc);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("ABC CHINESE", "129");
