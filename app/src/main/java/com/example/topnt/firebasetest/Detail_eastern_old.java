...
public class Detail_eastern_old extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_eastern_old);

        btnOrder = (Button) findViewById(R.id.btn_eastern_old);
        tableNumber = (EditText) findViewById(R.id.edt_eastern_old);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("OLD CUCUMBER", "129");
