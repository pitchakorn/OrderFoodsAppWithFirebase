...
public class Detail_fish_asam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_fish_asam);

        btnOrder = (Button) findViewById(R.id.btn_fish_asam);
        tableNumber = (EditText) findViewById(R.id.edt_fish_asam);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("ASAM FISH HEAD", "179");
