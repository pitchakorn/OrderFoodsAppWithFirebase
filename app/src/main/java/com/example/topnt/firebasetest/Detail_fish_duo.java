...
public class Detail_fish_duo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_fish_duo);

        btnOrder = (Button) findViewById(R.id.btn_fish_duo);
        tableNumber = (EditText) findViewById(R.id.edt_fish_duo);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("DUO SEASON SALMON PUFFS", "159");
