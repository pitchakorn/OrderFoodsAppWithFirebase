...
public class Detail_snack_chai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_chai);

        btnOrder = (Button) findViewById(R.id.btn_snack_chai);
        tableNumber = (EditText) findViewById(R.id.edt_snack_chai);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("CHAI PAO", "99");
