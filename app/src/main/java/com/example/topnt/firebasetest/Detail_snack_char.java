...
public class Detail_snack_char extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_char);

        btnOrder = (Button) findViewById(R.id.btn_snack_char);
        tableNumber = (EditText) findViewById(R.id.edt_snack_char);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("CHAR SIEW PAO", "99");
