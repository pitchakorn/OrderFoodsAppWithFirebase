...
public class Detail_snack_ginger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_ginger);

        btnOrder = (Button) findViewById(R.id.btn_snack_ginger);
        tableNumber = (EditText) findViewById(R.id.edt_snack_ginger);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("GINGER PAO", "99");
