...
public class Detail_snack_layer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_layer);

        btnOrder = (Button) findViewById(R.id.btn_snack_layer);
        tableNumber = (EditText) findViewById(R.id.edt_snack_layer);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("3 LAYER CAKE", "99");
