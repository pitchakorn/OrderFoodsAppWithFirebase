...
public class Detail_snack_onde extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_onde);

        btnOrder = (Button) findViewById(R.id.btn_snack_onde);
        tableNumber = (EditText) findViewById(R.id.edt_snack_onde);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("ONDE ONDE", "79");
