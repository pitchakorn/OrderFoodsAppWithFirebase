...
public class Detail_snack_yam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_snack_yam);

        btnOrder = (Button) findViewById(R.id.btn_snack_yam);
        tableNumber = (EditText) findViewById(R.id.edt_snack_yam);
            ...
            public void onClick(View v) {
                ...
                table_order.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        com.example.topnt.firebasetest.Model.Order order = new Order("YAM CAKE", "89");
